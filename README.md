...
Без Firebase приложение работает в **демо-режиме** с тестовыми данными.
...
На экране входа можно ввести любой email/пароль (или оставить пустыми) и нажать «Войти» — откроется демо-интерфейс.
